...
file_path = os.environ.get("RESPONSE_JSON_PATH", 'safety/language_barrier/language_barrier_evaluation_1000.gpt-4.1.llm_low_resource_attack_output.json')
...
async def process_item(item):
    plain_attack = item.get("low_resource_language_attack", "")
    answer_dict = item.get("answer_to_low_resource_language_attack", {})
    answer = answer_dict.get("translated_to_english", "")
